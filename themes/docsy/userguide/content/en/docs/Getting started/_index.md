...
*   **Copy and edit the source for the [Docsy example site](https://github.com/ewerkman/sitecorecommercecookbook).** This approach gives you a skeleton structure for your site, with top-level and documentation sections and templates that you can modify as necessary. The example site uses Docsy as a [Git submodule](https://git-scm.com/book/en/v2/Git-Tools-Submodules), so it's easy to [keep up to date](#keeping-the-theme-up-to-date).
...
1. Go to the [repo page](https://github.com/ewerkman/sitecorecommercecookbook) and click **Use this template**.
...
1.  In the [the Docsy example site's GitHub repo](https://github.com/ewerkman/sitecorecommercecookbook), click **Fork** and follow the prompts.
...
1.  Make a local working copy of the example site directly using `git clone`:
        ...
        git clone https://github.com/ewerkman/sitecorecommercecookbook.git
...
[example project](https://github.com/ewerkman/sitecorecommercecookbook).
...
Site-wide configuration details and parameters are defined in your project's `config.toml` file. These include your chosen Hugo theme (Docsy, of course!), project name, community links, Google Analytics configuration, and Markdown parser parameters. See the examples with comments in [`config.toml` in the example project](https://github.com/ewerkman/sitecorecommercecookbook/blob/master/config.toml) for how to add this information. **We recommend copying this `config.toml` and editing it even if you're just using the theme and not copying the entire Docsy example site**.
...
* Get some ideas from our [Example Site](https://github.com/ewerkman/sitecorecommercecookbook) and other [Examples](/docs/examples/).
